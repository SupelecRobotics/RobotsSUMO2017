...
class ColorDetection:
    ...
    def runWebcam():    
        ...
        cv2.createTrackbar("LowH", "Control", iLowH, 179, ColorDetection.nothing); # Hue (0 - 179)
        cv2.createTrackbar("HighH", "Control", iHighH, 179, ColorDetection.nothing);
        
        cv2.createTrackbar("LowS", "Control", iLowS, 255, ColorDetection.nothing); # Saturation (0 - 255)
        cv2.createTrackbar("HighS", "Control", iHighS, 255, ColorDetection.nothing);
