...
class Robot :
    ...
    def allerAangle(self, point,theta):
        ...
        if(self.traj.isInTheTravelableMap(point)) :
            ...
            # /!\ il faudrait rajouter un superModulo sur la différence !
            self.bouge(0, int(theta - self.theta))
            self.updatePosition()
...
#        self.printPosition()
    ...
    def gameFalse(self):
        ...
        if (self.couleur == 'J'):
            ...
            self.allerAangle((int(2700),int(260)),-900)
            self.com.appelDescenteClapGauche()
            self.allerAangle((int(2700),int(260)), -1800)
            self.com.appelMonteeClapGauche()
            # self.allerAangle((int(2300),int(260)), 1800)
            self.allerA((int(2300),int(260)))
            self.com.appelDescenteClapGauche()
            self.bouge(150, 0)
            self.com.appelMonteeClapGauche()
            # Optique ascenseur
            ...
            self.goToCylindreLocal((2130, 645),True)
            self.allerAangle((2400, 960), 0)
            self.allerA((2600, 960))
            self.com.appelDescenteActionneurGobeletDevant()
            self.com.appelOuvertureExternePinceDevant()
            self.allerA((2450,960))
            self.allerAangle((500,600),0)
            self.com.appelDescenteActionneurGobeletDerriere()
            self.allerAangle((600,210),-900)
            self.com.appelDescenteClapDroit()
            self.allerAangle((600,210),0)
            self.com.appelMonteeClapDroit()
            self.allerA((1400,650))
            self.goToGobeletLocal((1500,350),True)
            self.allerAangle((400,1500),2250)
            self.com.appelDescenteActionneurGobeletDevant()
            self.com.appelDescenteActionneurGobeletDerriere()
