...
#            self.bouge(-150,0)
#            time.sleep(1)
            self.allerAangle((int(250),int(240)), int(-900))
            self.com.appelDescenteClapDroit()
            self.allerAangle((int(250),int(240)), int(0))
            self.bouge(100,0)
            self.com.appelMonteeClapDroit()
            self.allerAangle((int(850),int(240)), int(-900))
            self.com.appelDescenteClapDroit()
            self.allerAangle((int(850),int(240)), int(0))
            self.bouge(100,0)
            self.com.appelMonteeClapDroit()
            # fait claps
...
#            #robot.com.appelDescenteGobeletDevant()
            self.allerAangle((int(2600),int(240)), int(1800))
...
#            time.sleep(1)
#            self.bouge(150,0)
            self.allerAangle((int(2750),int(240)), int(0))
            self.com.appelDescenteClapDroit()
            self.allerAangle((int(2750),int(240)), int(-900))
            self.com.appelMonteeClapDroit()
            self.allerAangle((int(2150),int(240)), int(0))
            self.com.appelDescenteClapDroit()
            self.allerAangle((int(2150),int(240)), int(-900))
            self.com.appelMonteeClapDroit()
            
#            self.allerAangle((int(600),int(1000)), int(1800))
#            #robot.com.appelDescenteGobeletDevant()
            self.allerAangle((int(400),int(240)), int(0))
            self.com.appelDescenteClapGauche()
            self.bouge(0,500)
            self.bouge(0,-500)
            self.bouge(200,0)
...
#        time.sleep(10)
        self.com.envoiDepartZone()
	if (self.couleur == 'J'):
		self.allerAangle((int(250),int(240)),-900)
		self.com.appelDescenteClapDroit()
		self.allerAangle((int(250),int(240)), 0)
		self.com.appelMonteeClapDroit()
	elif (self.couleur == 'V'):
		self.allerAangle((int(2750),int(240)),-900)
		self.com.appelDescenteClapGauche()
		self.allerAangle((int(2750),int(240)), -1800)
		self.com.appelMonteeClapGauche()
