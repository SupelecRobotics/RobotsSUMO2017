...
#            time.sleep(1)
            allerAangle((int(300),int(550)), int(-1170))
            time.sleep(1)
            bouge(150,0)
            #prend gobelet
            ...
            bouge(-150,0)
            time.sleep(1)
            allerAangle((int(250),int(250)), int(-900))
            com.appelDescenteClapDroit()
            allerAangle((int(250),int(250)), int(0))
            allerAangle((int(850),int(250)), int(-900))
            allerAangle((int(850),int(250)), int(0))
            bouge(100,0)
            com.appelMonteeClapDroit()
            # fait claps
            
            allerAangle((int(600),int(1000)), int(1800))
            #robot.com.appelDescenteGobeletDevant()
            allerAangle((int(2600),int(250)), int(1800))
            com.appelDescenteClapGauche()
            bouge(0,-500)
            bouge(0,500)
            bouge(200,0)
            com.appelMonteeClapGauche()
            time.sleep(1)
        elif (self.couleur == 'V'):
            allerAangle((int(2700),int(550)), int(-800))
            time.sleep(1)
            bouge(150,0)
